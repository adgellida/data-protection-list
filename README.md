...
* Use an application, such as RethinkDNS or Blokada, that allows you to block trackers as well as advertisements and use an encrypted respectful DNS server
